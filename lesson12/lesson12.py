...
driver_path = "/home/aab/tests"
# driver_path = "/home/aab/Yandex.Disk/Python/Scraping/Bin/PyToDay/lesson12"
    ...
    for url in urls_list:
        ...
        try:
            item_phones = soup.find(
                "div",
                class_="service-phones-list").find_all(
...
def main():
    get_source_html(
        url="https://spb.zoon.ru/medical/"
            "?search_query_form=1&m%5B5200e522a0f302f066000055%5D="
            "1&center%5B%5D=59.91878264665887&center%5B%5D="
            "30.342586983263384&zoom=10")
